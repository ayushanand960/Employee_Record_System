    ...
    // Delay function used for delaying and pausing for some milli seconds...
    void delay(int j)
    {
        int k;
        for (int i = 0; i < j; i++)
    ...
    int main(void)
    {
        ...
        int choice;
        system("cls");
        welcome(); //Calling welcome pattern
        printf("\n\n\t\t\t\t\t\t\t\t\t\t\t@ Ayush Anand");
